...
function MediaDetail({ contentId }: { contentId: string }) {
  ...
  const ottList = [
    { name: 'Netflix', img: '/ott/netflix.svg' },
    { name: 'Disney Plus', img: '/ott/disney.svg' },
    { name: 'Watcha', img: '/ott/watcha.svg' },
    { name: 'Wavve', img: '/ott/wavve.svg' },
  ];
            ...
            <div className="title-flex">
              ...
              <S_Content>
                ...
                <S_TitleFont>
                  ...
                  {/* <span className="bold-yellow">{data.title}</span> */}
                  <h1 className="h1">
                    컨텐츠 보러가기 </h1>
                  <div className="ott">
                  ...
                  <h1 className="bold-white">
                    출시일: {formatReleaseDate(data.releaseDate)}
                  </h1>
