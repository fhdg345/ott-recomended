...
function OttBtn() {
  ...
  if (path === '/tv' || path === '/movie') {
    return (
      <>
        <S_Ott
          src={`${import.meta.env.VITE_IMAGE_URL}/ott/netflix.svg`}
          alt="Netflix"
          onClick={() => navigate(`${path}/list?ott=Netflix`)}
        />
        <S_Ott
          src={`${import.meta.env.VITE_IMAGE_URL}/ott/disney.svg`}
          alt="Disney Plus"
          onClick={() => navigate(`${path}/list?ott=Disney Plus`)}
        />
        <S_Ott
          src={`${import.meta.env.VITE_IMAGE_URL}/ott/watcha.svg`}
          alt="Watcha"
          onClick={() => navigate(`${path}/list?ott=Watcha`)}
        />
        <S_Ott
          src={`${import.meta.env.VITE_IMAGE_URL}/ott/wavve.svg`}
          alt="Wavve"
