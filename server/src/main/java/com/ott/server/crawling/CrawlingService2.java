...
public class CrawlingService2 {
    ...
    public CrawlingService2(MediaService mediaService) {
...
//        Thread.sleep(500);
        ...
        try{
            WebElement element111 = driver.findElement(By.cssSelector("button.sc-dcJsrY.dQaUXI"));
        ...
        By searchFieldCss = By.cssSelector("button.sc-dcJsrY.dQaUXI");
        WebElement searchField = webDriverWait.until(elementToBeClickable(searchFieldCss));
        searchField.click();

        // '모든것을 받아 들인다' 버튼 클릭  data-testid="uc-accept-all-button"
        WebElement acceptAllButton = webDriverWait.until(elementToBeClickable(By.xpath("//button[@data-testid='uc-accept-all-button']")));
        ...
        // '설정 저장' 버튼 클릭
        WebElement saveButton = webDriverWait.until(elementToBeClickable(By.xpath("//button[@data-testid='uc-save-button']")));
        saveButton.click();
        Thread.sleep(500);
